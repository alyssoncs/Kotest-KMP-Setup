...
It includes a minimal, working test setup across typical KMP source sets (for example: `commonTest`, `jvmTest`, `androidHostTest`) so you can copy the configuration into your own project.
